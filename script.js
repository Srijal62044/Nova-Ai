 ...
 * Both old (AIza...) and new (AQ...) key formats are passed via
 * the x-goog-api-key header — this works for all key types.
 */
...
// Only modern models are listed; deprecated ones (gemini-pro, gemini-1.0-pro) are excluded.
